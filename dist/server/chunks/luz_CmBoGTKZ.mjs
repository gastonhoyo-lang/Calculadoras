...
const $$Luz = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de Consumo Eléctrico | Estimá tu factura de luz", "description": "Calculá cuántos kWh consumen tus electrodomésticos por mes. Herramienta para ahorrar energía y anticipar el costo de tu factura eléctrica." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="max-w-4xl mx-auto px-4"> <header class="text-center mb-12"> <h1 class="text-4xl md:text-6xl font-black text-slate-900 tracking-tight mb-4">
