...
const $$RetiroFire = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora FIRE | ¿Cuánto dinero necesitás para jubilarte?", "description": "Calculá tu número de Independencia Financiera basado en la Regla del 4%. Descubrí cuánto capital necesitás para vivir de tus rentas." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="max-w-4xl mx-auto px-4 py-12"> <header class="text-center mb-12"> <h1 class="text-4xl md:text-6xl font-black text-slate-900 tracking-tight">
