...
const $$FraccionADecimal = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de Fracción a Decimal | Convertir Racionales", "description": "Convertí cualquier fracción en un número decimal al instante. Herramienta gratuita para entender la relación entre quebrados y decimales." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="max-w-4xl mx-auto px-4 py-12"> <div class="text-center mb-10"> <h1 class="text-4xl font-black text-slate-900 mb-4 tracking-tight">
Fracción a Decimal
