...
const $$LongitudTituloSeo = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de Longitud de Título SEO | Evitá el recorte en Google", "description": "Verificá si tu Meta Title tiene la extensión correcta. Calculá la longitud ideal en caracteres para maximizar tu visibilidad en buscadores." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="max-w-4xl mx-auto px-4 py-12"> <div class="text-center mb-10"> <h1 class="text-4xl font-black text-slate-900 mb-4 tracking-tight">
