...
const $$Combustible = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de Consumo de Combustible | Costo por Viaje", "description": "Calculá cuánto combustible consume tu auto por kilómetro y el costo total de tu próximo viaje. Ideal para ahorrar en nafta o diesel." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="max-w-4xl mx-auto px-4"> <header class="text-center mb-12"> <h1 class="text-4xl md:text-6xl font-black text-slate-900 tracking-tight mb-4">
