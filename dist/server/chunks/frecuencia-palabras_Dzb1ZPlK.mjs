...
const $$FrecuenciaPalabras = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de Frecuencia de Palabras | Análisis Semántico", "description": "Contá cuántas veces aparece cada palabra en tu texto. Identificá patrones de escritura y optimizá la relevancia semántica de tu contenido." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="max-w-4xl mx-auto px-4 py-12"> <div class="text-center mb-10"> <h1 class="text-4xl font-black text-slate-900 mb-4 tracking-tight">
