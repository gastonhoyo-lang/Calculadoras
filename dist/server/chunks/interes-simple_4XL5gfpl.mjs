...
const $$InteresSimple = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de Interés Simple | Ganancias en Préstamos e Inversiones", "description": "Calculá el interés generado por un capital inicial. Aprendé la fórmula de interés simple y cómo aplicarla a tus finanzas personales." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="max-w-4xl mx-auto px-4 py-12"> <header class="text-center mb-12"> <h1 class="text-4xl md:text-6xl font-black text-slate-900 mb-4 tracking-tight">
...
</p> </div> <div class="mt-16 space-y-12"> <h3 class="text-3xl font-black text-slate-800 mb-8 text-center">
Ejemplos prácticos de Interés Simple
</h3> <div class="grid md:grid-cols-3 gap-6"> <div class="p-6 bg-slate-50 rounded-3xl border border-slate-100"> <h4 class="font-bold text-blue-600 mb-2 italic text-sm">
Préstamo personal
</h4> <p class="text-xs leading-relaxed">
Si pedís <strong>$5.000</strong> a una tasa del <strong>10% anual</strong> por 2 años, pagarás <strong>$1.000</strong> de intereses en total.
              El capital no cambia.
</p> </div> <div class="p-6 bg-slate-50 rounded-3xl border border-slate-100"> <h4 class="font-bold text-blue-600 mb-2 italic text-sm">
Inversión en Bonos
</h4> <p class="text-xs leading-relaxed">
Muchos bonos pagan cupones de interés simple. Recibís la misma
              ganancia periódicamente basada en tu <strong>inversión inicial</strong>.
</p> </div> <div class="p-6 bg-slate-50 rounded-3xl border border-slate-100"> <h4 class="font-bold text-blue-600 mb-2 italic text-sm">
Notas de crédito
</h4> <p class="text-xs leading-relaxed">
En el comercio minorista, el interés por mora suele ser simple,
              calculándose solo sobre el <strong>monto adeudado</strong> original.
</p> </div> </div> <div class="space-y-6"> <h3 class="text-2xl font-bold text-slate-800">
Preguntas Frecuentes sobre Interés Simple
</h3> <div class="border-b border-slate-100 pb-4"> <h4 class="font-bold text-slate-700 mb-1 italic text-sm">
¿Cuándo conviene usar interés simple en lugar de compuesto?
</h4> <p class="text-xs">
El interés simple es ideal para préstamos a corto plazo o
              inversiones donde necesitás retirar tus ganancias mensualmente sin
              reinvertirlas.
</p> </div> <div class="border-b border-slate-100 pb-4"> <h4 class="font-bold text-slate-700 mb-1 italic text-sm">
¿Cómo pasar la tasa mensual a anual para la calculadora?
</h4> <p class="text-xs">
Si tenés una tasa mensual, simplemente multiplicala por 12. Por
              ejemplo, una tasa del 2% mensual equivale a un 24% anual.
</p> </div> <div class="border-b border-slate-100 pb-4"> <h4 class="font-bold text-slate-700 mb-1 italic text-sm">
¿Qué significa que el crecimiento sea lineal?
</h4> <p class="text-xs">
Significa que la ganancia es constante. Si ganás $100 el primer
              año, ganarás $100 todos los años siguientes, sin importar cuánto
              tiempo pase.
</p> </div> </div> </div> </article> </div> ${renderScript($$result2, "C:/proyectos/seo-tools/src/pages/finanzas/interes-simple.astro?astro&type=script&index=0&lang.ts")} ` })}`;
