...
const $$DensidadKeyword = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de Densidad de Keywords SEO | Analizador de Frecuencia", "description": "Analizá la densidad de palabras clave de tus artículos. Evitá el keyword stuffing y optimizá tu contenido para los algoritmos de Google." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="max-w-4xl mx-auto px-4 py-12"> <div class="text-center mb-10"> <h1 class="text-4xl font-black text-slate-900 mb-4 tracking-tight">
