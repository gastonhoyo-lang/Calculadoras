...
const $$AmortizacionPrestamo = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de Amortización de Préstamo | Sistema Francés", "description": "Generá tu tabla de amortización completa. Descubrí cuánto pagás de intereses y capital en cada cuota de tu préstamo." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="max-w-5xl mx-auto px-4 py-12"> <div class="text-center mb-10"> <h1 class="text-4xl font-black text-slate-900 mb-4 tracking-tight">
