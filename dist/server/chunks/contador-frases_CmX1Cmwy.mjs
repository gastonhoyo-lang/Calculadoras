...
const $$ContadorFrases = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Contador de Frases | Analizador de Ritmo y Lectura SEO", "description": "Contá el número de frases de tu texto y analizá su longitud. Mejorá la legibilidad de tu contenido para que sea fácil de entender por humanos y buscadores." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="max-w-4xl mx-auto px-4 py-12"> <div class="text-center mb-10"> <h1 class="text-4xl font-black text-slate-900 mb-4 tracking-tight">
Contador de Frases
