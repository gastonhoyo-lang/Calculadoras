...
const $$Calorias = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de Calorías | TMB y Gasto Energético", "description": "Calculá cuántas calorías quema tu cuerpo en reposo (Tasa Metabólica Basal) y cuántas necesitás para mantener o perder peso." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="max-w-4xl mx-auto px-4"> <header class="text-center mb-12"> <h1 class="text-4xl md:text-6xl font-black text-slate-900 tracking-tight mb-4">
