...
const $$Pitagoras = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de Pitágoras | Hallar Hipotenusa y Catetos", "description": "Resolvé triángulos rectángulos usando el Teorema de Pitágoras. Calculá la hipotenusa o los catetos de forma automática." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="max-w-4xl mx-auto px-4"> <header class="text-center mb-12"> <h1 class="text-4xl md:text-6xl font-black text-slate-900 tracking-tight mb-4">
