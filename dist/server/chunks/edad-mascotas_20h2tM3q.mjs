...
const $$EdadMascotas = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de Edad de Perros y Gatos | Chieffin", "description": "Descubrí cuántos años humanos tiene tu mascota. Cálculo preciso según tamaño del perro y etapa del gato." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="max-w-4xl mx-auto px-4"> <header class="text-center mb-12"> <h1 class="text-4xl md:text-6xl font-black text-slate-900 mb-4">
