...
const $$Embarazo = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de Embarazo | Semanas y Fecha de Parto", "description": "Calculá cuántas semanas de embarazo tenés, en qué trimestre estás y tu fecha probable de parto fácilmente con la Regla de Naegele." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="max-w-4xl mx-auto px-4"> <header class="text-center mb-12"> <h1 class="text-4xl md:text-6xl font-black text-slate-900 mb-4">
