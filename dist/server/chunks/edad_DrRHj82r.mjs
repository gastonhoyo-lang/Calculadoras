...
const $$Edad = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de Edad Exacta | ¿Cuántos días y horas viviste?", "description": "Descubrí tu edad exacta en años, meses, días y hasta segundos. Una herramienta precisa para conocer tu cronología personal en el mundo." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="max-w-4xl mx-auto px-4 py-12"> <header class="text-center mb-12"> <h1 class="text-4xl md:text-6xl font-black text-slate-900 tracking-tight mb-4">
