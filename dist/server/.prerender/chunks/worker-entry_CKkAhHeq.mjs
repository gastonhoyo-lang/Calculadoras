...
const renderers = [];
const serializedData = [{ "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/utiles/[slug]", "isIndex": false, "type": "page", "pattern": "^\\/utiles\\/([^/]+?)\\/?$", "segments": [[{ "content": "utiles", "dynamic": false, "spread": false }], [{ "content": "slug", "dynamic": true, "spread": false }]], "params": ["slug"], "component": "src/pages/utiles/[slug].astro", "prerender": true, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/[categoria]", "isIndex": false, "type": "page", "pattern": "^\\/([^/]+?)\\/?$", "segments": [[{ "content": "categoria", "dynamic": true, "spread": false }]], "params": ["categoria"], "component": "src/pages/[categoria].astro", "prerender": true, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }];
serializedData.map(deserializeRouteInfo);
const _page0 = () => import("./_slug__DNZHae13.mjs");
const _page1 = () => import("./_categoria__FFIjPvCn.mjs");
const pageMap = /* @__PURE__ */ new Map([
  ["src/pages/utiles/[slug].astro", _page0],
  ["src/pages/[categoria].astro", _page1]
]);
