...
const $$Agua = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de Agua Diaria | \xBFCu\xE1ntos litros tomar?", "description": "Descubr\xED cu\xE1nta agua necesita tu cuerpo por d\xEDa seg\xFAn tu peso y actividad f\xEDsica. Herramienta de salud basada en recomendaciones m\xE9dicas." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="max-w-4xl mx-auto px-4"> <header class="text-center mb-12"> <h1 class="text-4xl md:text-6xl font-black text-slate-900 tracking-tight mb-4">
