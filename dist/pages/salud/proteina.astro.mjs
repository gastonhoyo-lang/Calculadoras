...
const $$Proteina = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de Prote\xEDna Diaria | Chieffin Fitness", "description": "Calcul\xE1 cu\xE1nta prote\xEDna necesit\xE1s por d\xEDa seg\xFAn tu peso y nivel de entrenamiento para ganar m\xFAsculo o mantenerte." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="max-w-4xl mx-auto px-4"> <header class="text-center mb-12"> <h1 class="text-4xl font-black text-slate-900">
