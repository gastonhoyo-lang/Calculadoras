...
const $$Imc = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de IMC | \xCDndice de Masa Corporal", "description": "Calcul\xE1 tu IMC de forma r\xE1pida y gratuita. Descubr\xED si est\xE1s en tu peso ideal seg\xFAn los est\xE1ndares de la OMS." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="max-w-4xl mx-auto px-4"> <header class="text-center mb-12"> <h1 class="text-4xl md:text-6xl font-black text-slate-900 tracking-tight mb-4">
