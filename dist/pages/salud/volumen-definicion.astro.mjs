...
${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de Volumen y Definici\xF3n | Macros para Gym", "description": "Calcul\xE1 tus calor\xEDas y macronutrientes para ganar masa muscular o perder grasa. Ajust\xE1 tu dieta seg\xFAn tu objetivo f\xEDsico." }, { "default": ($$result2) => renderTemplate`${maybeRenderHead()}<div class="max-w-4xl mx-auto px-4"><header class="text-center mb-12"><h1 class="text-4xl md:text-6xl font-black text-slate-900 tracking-tight mb-4">
