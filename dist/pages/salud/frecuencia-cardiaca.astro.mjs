...
</h2> <input type="number" id="edadFC" placeholder="Tu edad" class="w-full p-4 bg-slate-50 rounded-2xl mb-6 outline-none font-bold text-center text-xl border-2 border-transparent focus:border-red-500"> <button id="btnFC" class="w-full bg-red-600 text-white p-4 rounded-2xl font-bold hover:bg-red-700 transition-all">Calcular FC Máx</button> <div id="resFC" class="hidden mt-8 space-y-2 animate-in fade-in zoom-in"> <p class="text-slate-500 font-medium">Tu máximo estimado es:</p> <div class="text-5xl font-black text-slate-900"> <span id="valFC"></span> PPM
</div> <p class="text-[10px] text-slate-400 mt-4 italic">
