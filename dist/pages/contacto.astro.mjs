/* empty css                                       */
import { c as createAstro, a as createComponent, r as renderComponent, b as renderTemplate, m as maybeRenderHead } from '../chunks/astro/server_Dh-0FtxX.mjs';
import 'piccolore';
...
const $$Contacto = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Contacto y Acerca de | Chieffin", "description": "Conoc\xE9 m\xE1s sobre el proyecto Chieffin, nuestra misi\xF3n de simplificar c\xE1lculos diarios y c\xF3mo ponerte en contacto con nosotros." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="max-w-4xl mx-auto px-4 py-16"> <div class="grid md:grid-cols-2 gap-16 items-center"> <section class="space-y-6"> <span class="text-indigo-600 font-black uppercase tracking-widest text-xs italic">Sobre el Proyecto</span> <h1 class="text-4xl md:text-5xl font-black text-slate-900 leading-tight">
