...
const $$MetaAhorro = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de Meta de Ahorro | Chieffin", "description": "Planific\xE1 tus sue\xF1os. Calcul\xE1 cu\xE1nto dinero necesit\xE1s ahorrar mensualmente para alcanzar tu objetivo en el tiempo que desees." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="max-w-4xl mx-auto px-4"> <header class="text-center mb-12"> <span class="bg-emerald-100 text-emerald-700 px-4 py-1.5 rounded-full text-xs font-black uppercase tracking-widest">Planificación</span> <h1 class="text-4xl md:text-6xl font-black text-slate-900 mt-6 mb-4 tracking-tight">
