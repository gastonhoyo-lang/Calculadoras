/* empty css                                          */
import { a as createComponent, r as renderComponent, d as renderScript, b as renderTemplate, m as maybeRenderHead } from '../../chunks/astro/server_Dh-0FtxX.mjs';
import 'piccolore';
...
</h3> <ul class="space-y-4 text-slate-600"> <li> <strong>IVA:</strong> Multiplicá por 0.21 para obtener el impuesto.
</li> <li> <strong>Descuentos:</strong> Restá el porcentaje del total inicial.
</li> </ul> </article> </div> ` })} ${renderScript($$result, "C:/proyectos/seo-tools/src/pages/finanzas/porcentaje.astro?astro&type=script&index=0&lang.ts")}`;
