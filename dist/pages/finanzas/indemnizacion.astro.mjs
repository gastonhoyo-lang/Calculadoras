...
const $$Indemnizacion = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de Indemnizaci\xF3n por Despido | Chieffin", "description": "Calcul\xE1 tu liquidaci\xF3n estimada por despido sin causa seg\xFAn la Ley de Contrato de Trabajo (Art. 245)." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="max-w-4xl mx-auto px-4"> <header class="text-center mb-12"> <span class="bg-red-100 text-red-700 px-4 py-1.5 rounded-full text-xs font-black uppercase tracking-widest">Derechos del Trabajador</span> <h1 class="text-4xl md:text-6xl font-black text-slate-900 mt-6 mb-4 tracking-tight">
