...
const $$Ganancias = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de Impuesto a las Ganancias 2026 | Chieffin", "description": "Calcul\xE1 el impacto del Impuesto a las Ganancias en tu sueldo. Estim\xE1 retenciones seg\xFAn el m\xEDnimo no imponible vigente." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="max-w-4xl mx-auto px-4"> <header class="text-center mb-12"> <span class="bg-red-100 text-red-700 px-4 py-1.5 rounded-full text-xs font-black uppercase tracking-widest">Impuestos</span> <h1 class="text-4xl md:text-6xl font-black text-slate-900 mt-6 mb-4 tracking-tight">
