...
const $$Inflacion = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de Inflaci\xF3n | \xBFCu\xE1nto perdi\xF3 tu dinero?", "description": "Calcul\xE1 el impacto de la inflaci\xF3n en tus ahorros. Descubr\xED cu\xE1nto dinero necesit\xE1s hoy para mantener el mismo poder adquisitivo de hace un a\xF1o." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="max-w-4xl mx-auto px-4 py-12"> <header class="text-center mb-12"> <h1 class="text-4xl md:text-6xl font-black text-slate-900 tracking-tight mb-4">
