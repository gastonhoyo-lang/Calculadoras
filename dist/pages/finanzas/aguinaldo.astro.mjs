...
const $$Aguinaldo = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de Aguinaldo (SAC) | Chieffin", "description": "Calcul\xE1 cu\xE1nto vas a cobrar de aguinaldo en junio o diciembre, incluyendo el c\xE1lculo proporcional por d\xEDas trabajados." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="max-w-4xl mx-auto px-4"> <header class="text-center mb-12"> <span class="bg-emerald-100 text-emerald-700 px-4 py-1.5 rounded-full text-xs font-black uppercase tracking-widest">Derecho Laboral</span> <h1 class="text-4xl md:text-6xl font-black text-slate-900 mt-6 mb-4 tracking-tight">
