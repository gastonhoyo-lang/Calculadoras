/* empty css                                          */
import { a as createComponent, r as renderComponent, b as renderTemplate, m as maybeRenderHead } from '../../chunks/astro/server_Dh-0FtxX.mjs';
import 'piccolore';
import { $ as $$Layout } from '../../chunks/Layout_Df3_LbUR.mjs';
export { renderers } from '../../renderers.mjs';

const $$ComprarVsAlquilar = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "\xBFComprar o Alquilar Casa? | Calculadora de Comparaci\xF3n Financiera", "description": "Compar\xE1 si te conviene comprar una propiedad con hipoteca o seguir alquilando e invirtiendo. An\xE1lisis de costos a 10 a\xF1os." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="max-w-4xl mx-auto px-4 py-12"> <header class="text-center mb-12"> <h1 class="text-4xl md:text-6xl font-black text-slate-900 tracking-tight mb-4">
