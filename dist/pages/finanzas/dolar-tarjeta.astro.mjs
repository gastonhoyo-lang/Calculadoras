...
const $$DolarTarjeta = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de D\xF3lar Tarjeta | Chieffin", "description": "Calcul\xE1 el precio final de tus compras con tarjeta de cr\xE9dito en d\xF3lares, incluyendo Impuesto PAIS y percepciones." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="max-w-4xl mx-auto px-4"> <header class="text-center mb-12"> <span class="bg-blue-100 text-blue-700 px-4 py-1.5 rounded-full text-xs font-black uppercase tracking-widest">Impuestos Argentina</span> <h1 class="text-4xl md:text-6xl font-black text-slate-900 mt-6 mb-4 tracking-tight">
