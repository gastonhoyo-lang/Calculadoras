...
const $$ConsumoElectrico = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de Consumo El\xE9ctrico | Chieffin", "description": "Calcul\xE1 el consumo en kWh de tus electrodom\xE9sticos y estim\xE1 cu\xE1nto vas a pagar en tu pr\xF3xima factura de energ\xEDa." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="max-w-4xl mx-auto px-4"> <header class="text-center mb-12"> <span class="bg-yellow-100 text-yellow-700 px-4 py-1.5 rounded-full text-xs font-black uppercase tracking-widest">Ahorro en el Hogar</span> <h1 class="text-4xl md:text-6xl font-black text-slate-900 mt-6 mb-4 tracking-tight">
