...
const $$Hormigon = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de Hormig\xF3n y Materiales | Chieffin", "description": "Calcul\xE1 cu\xE1ntos metros c\xFAbicos de hormig\xF3n necesit\xE1s y la cantidad de cemento, arena y piedra para tu construcci\xF3n." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="max-w-4xl mx-auto px-4"> <header class="text-center mb-12"> <span class="bg-slate-100 text-slate-700 px-4 py-1.5 rounded-full text-xs font-black uppercase tracking-widest">Construcción Técnica</span> <h1 class="text-4xl md:text-6xl font-black text-slate-900 mt-6 mb-4 tracking-tight">
