...
const $$Pintura = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de Pintura | \xBFCu\xE1ntos litros necesito?", "description": "Calcul\xE1 la cantidad exacta de pintura para tus paredes. Evit\xE1 gastos innecesarios con nuestro simulador de litros por metro cuadrado." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="max-w-4xl mx-auto px-4"> <header class="text-center mb-12"> <h1 class="text-4xl md:text-6xl font-black text-slate-900 tracking-tight mb-4">
