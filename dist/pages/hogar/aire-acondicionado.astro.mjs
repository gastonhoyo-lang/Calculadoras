...
const $$AireAcondicionado = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de Frigor\xEDas para Aire Acondicionado | Chieffin", "description": "Calcul\xE1 cu\xE1ntas frigor\xEDas (BTU) necesita tu habitaci\xF3n para enfriar correctamente. Evit\xE1 gastar de m\xE1s o comprar un equipo chico." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="max-w-4xl mx-auto px-4"> <header class="text-center mb-12"> <span class="bg-blue-100 text-blue-700 px-4 py-1.5 rounded-full text-xs font-black uppercase tracking-widest">Hogar y Confort</span> <h1 class="text-4xl md:text-6xl font-black text-slate-900 mt-6 mb-4 tracking-tight">
