...
const $$PrecioVenta = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de Precio de Venta | Chieffin", "description": "Establec\xE9 el precio ideal de tus productos bas\xE1ndote en tus costos y el margen de ganancia deseado." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="max-w-4xl mx-auto px-4"> <header class="text-center mb-12"> <h1 class="text-4xl font-black text-slate-900 mb-4">
