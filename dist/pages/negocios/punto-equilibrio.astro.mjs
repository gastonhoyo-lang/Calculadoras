...
const $$PuntoEquilibrio = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de Punto de Equilibrio | Finanzas para Emprendedores", "description": "Calcul\xE1 el punto de equilibrio de tu negocio. Descubr\xED cu\xE1ntas unidades necesit\xE1s vender para cubrir tus costos fijos y variables." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="max-w-4xl mx-auto px-4"> <header class="text-center mb-12"> <h1 class="text-4xl md:text-6xl font-black text-slate-900 tracking-tight mb-4">
