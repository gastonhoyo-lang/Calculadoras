...
const $$TarifaFreelance = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de Tarifa Freelance | \xBFCu\xE1nto cobrar por hora?", "description": "Calcul\xE1 tu valor hora profesional de forma precisa. Consider\xE1 gastos, impuestos, d\xEDas de vacaciones y tu sueldo deseado para no perder dinero." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="max-w-4xl mx-auto px-4 py-12"> <header class="text-center mb-12"> <h1 class="text-4xl md:text-6xl font-black text-slate-900 tracking-tight">
