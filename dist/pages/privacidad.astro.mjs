...
const $$Privacidad = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Pol\xEDticas de Privacidad y T\xE9rminos de Uso | Chieffin", "description": "Informaci\xF3n sobre el tratamiento de datos, uso de cookies y t\xE9rminos de servicio de las herramientas de Chieffin." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="max-w-3xl mx-auto px-4 py-16"> <header class="mb-12 border-b border-slate-100 pb-8"> <h1 class="text-4xl font-black text-slate-900 mb-4 tracking-tight">
