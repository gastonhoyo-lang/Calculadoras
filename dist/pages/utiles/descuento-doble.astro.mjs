...
const $$DescuentoDoble = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de Descuento Doble o Sucesivo | Chieffin", "description": "Calcul\xE1 el descuento real cuando se aplican dos rebajas juntas (ej: 20% + 10%). No se suman, se encadenan." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="max-w-4xl mx-auto px-4"> <header class="text-center mb-12"> <span class="bg-pink-100 text-pink-700 px-4 py-1.5 rounded-full text-xs font-black uppercase tracking-widest">Matemática Comercial</span> <h1 class="text-4xl md:text-6xl font-black text-slate-900 mt-6 mb-4 tracking-tight">
