...
const $$Horas = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de Diferencia de Horas | Calcular tiempo transcurrido", "description": "Calcul\xE1 f\xE1cilmente cu\xE1ntas horas y minutos hay entre dos momentos del d\xEDa. Ideal para control de horarios laborales y horas de sue\xF1o." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="max-w-4xl mx-auto px-4"> <header class="text-center mb-12"> <h1 class="text-4xl md:text-6xl font-black text-slate-900 tracking-tight mb-4">
