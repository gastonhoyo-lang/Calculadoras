...
const $$CostoPorUso = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Calculadora de Costo por Uso | \xBFVale la pena la compra? | Chieffin", "description": "Aprend\xE9 a comprar de forma inteligente. Calcul\xE1 el costo real de cualquier producto bas\xE1ndote en la cantidad de veces que lo vas a utilizar." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="max-w-4xl mx-auto px-4"> <header class="text-center mb-12"> <span class="bg-emerald-100 text-emerald-700 px-4 py-1.5 rounded-full text-xs font-black uppercase tracking-widest">Consumo Inteligente</span> <h1 class="text-4xl md:text-6xl font-black text-slate-900 mt-6 mb-4 tracking-tight">
