...
La raíz cuadrada de un número $x$ es aquel número $y$ que, al ser
        multiplicado por sí mismo (elevado al cuadrado), da como resultado el
        número original. Se representa con el símbolo radical.
</p> <div class="bg-slate-900 p-8 rounded-3xl text-center my-8 shadow-2xl"> <span class="text-emerald-400 font-mono text-3xl">$$\\sqrt${x} = y \\iff y^2 = x$$</span> </div> <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12"> <div class="p-6 bg-slate-50 rounded-2xl border border-slate-200"> <h4 class="font-bold text-slate-900 mb-2">Raíces Exactas</h4> <p class="text-xs leading-relaxed">
Son números cuyo resultado es un entero. Por ejemplo, $\\sqrt${16} = 4$.
            Conocer estos "cuadrados perfectos" ayuda a agilizar cálculos mentales
